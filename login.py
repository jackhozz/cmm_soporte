...
import dbsopporte as dbs  # Importamos el módulo de soporte de base de datos personalizado
import sqlite3  # Librería para manejar bases de datos SQLite. Instalación: incluida en Python estándar
